        ...
        <div class="grid-container">
            ...
            <main class="main-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach items="${agendamentosEspera}" var="agendamento">
                            <c:if test="${agendamento.status eq 'em espera'}">
                                <tr>
                                    ...
                                    <td>
                                        <form action="srvA" method="post">
                                            <input type="hidden" name="acao" value="confirmarAgendamento">
                                            <input type="hidden" name="idAgendamento" value="${agendamento.idAgendamento}">
                                            <button class="button-28" role="button" type="submit">Confirmar</button>
                                        </form> 
                                    </td>
                                </c:if>
                            </tr>
