<%-- 
    Document   : clienteAgendamentos
    Created on : 31/05/2023, 09:43:22
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <section id="sidebar">
            ...
            <ul class="side-menu">
                <li>
                    <a href="index.jsp" class="logout" onclick="goBack()">
                        ...
                        <table>
                            ...
                            <tbody>
                                <c:forEach items="${agendamentos}" var="agendamento">
                                    <%-- Remover agendamentos expirados --%>

                                    <tr>
                                        <td>${agendamento.getNome_cliente()}</td>
                                        <td>${agendamento.getData_agendamento()}</td>
                                        <td>${agendamento.getServico()}</td>
                                        <td>${agendamento.getFuncionario()}</td>
                                        <td>${agendamento.getStatus()}</td>
                                        <td>
                                            <form action="srvA" method="post">
                                                <input type="hidden" name="acao" value="cancelarAgendamento">
                                                <input type="hidden" name="idAgendamento" value="${agendamento.getIdAgendamento()}">
                                                <button class="button-28" role="button" type="submit">Cancelar</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
