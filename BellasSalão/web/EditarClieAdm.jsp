            ...
            <main class="main-container">
                <main class="main-container">
                    ...
                    <form class="profile-form" action="srvc" method="POST">
                        ...
                        <input type="text" id="email" name="txtEmail" value="${cliente.email}" required>
                        <label for="txtTel">Telefone:</label>
                        <input type="tel" id="telefone" name="txtTel" value="${cliente.telefone}" required>
                        <label for="txtUsuario">Usuário:</label>
                        <input type="text" id="usuario" name="txtUsuario" value="${cliente.usuario}" required>

                        <label for="txtSenha">Senha:</label>
                        <input type="password" id="senha" name="txtSenha" value="${cliente.senha}" required>

                        

                        <input type="hidden" value="atualizarAdm" id="acao" name="acao">
